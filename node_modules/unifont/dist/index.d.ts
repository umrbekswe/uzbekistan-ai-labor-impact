...
interface InitializedProvider {
    resolveFont: (family: string, options: ResolveFontOptions) => Awaitable$1<ResolveFontResult | undefined>;
}
interface ProviderDefinition<T = unknown> {
    (options: T, ctx: ProviderContext): Awaitable$1<InitializedProvider | undefined>;
}
interface Provider {
    _name: string;
    (ctx: ProviderContext): Awaitable$1<InitializedProvider | undefined>;
}
...
declare namespace providers {
  export { _default$5 as adobe, _default$4 as bunny, _default$3 as fontshare, _default$2 as fontsource, _default$1 as google, _default as googleicons };
}
...
export { type FontFaceData, type FontStyles, type LocalFontSource, type Provider, type ProviderContext, type ProviderDefinition, type ProviderFactory, type RemoteFontSource, type ResolveFontOptions, type Unifont, type UnifontOptions, createUnifont, defaultResolveOptions, defineFontProvider, providers };
